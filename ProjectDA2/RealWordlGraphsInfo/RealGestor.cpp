...
void RealGestor::gestor_nodes_1(RealGraph &aux1){
    ...
    while(getline(nodesf,line)){
        ...
        if(i==0){
            aux1.addVertex(i, stod(longitude), stod(latitude));
...
void RealGestor::gestor_travel1(RealGraph &aux1) {
    ...
    while(getline(travelf,line)){
        ...
        aux1.addBidirectionalEdge(nodes_id_1.at(stoi(node_from_id)),nodes_id_1.at(stoi(node_to_id)),stod(distancia));
    }
}
...
void RealGestor::gestor_nodes_2(RealGraph &aux2){
    ...
    while(getline(nodesf,line)){
        ...
        Node Node(stoi(id),stod(longitude),stod(latitude));
        if(i==2){
            aux2.addVertex(i,stod(longitude),stod(latitude));
...
void RealGestor::gestor_travel2(RealGraph &aux2) {
    ...
    while(getline(travelf,line)){
        ...
        aux2.addBidirectionalEdge(nodes_id_2.at(stoi(node_from_id)),nodes_id_2.at(stoi(node_to_id)),stod(distancia));
    }
}
...
void RealGestor::gestor_nodes_3(RealGraph &aux3){
    ...
    while(getline(nodesf,line)){
        ...
        Node Node(stoi(id),stod(longitude),stod(latitude));
        if(i==0){
            aux3.addVertex(i,stod(longitude),stod(latitude));
...
void RealGestor::gestor_travel3(RealGraph &aux3) {
    ...
    while(getline(travelf,line)){
        ...
        aux3.addBidirectionalEdge(nodes_id_3.at(stoi(node_from_id)),nodes_id_3.at(stoi(node_to_id)),stod(distancia));
    }
}
...
unordered_map<int, Node> RealGestor::getNodes() const{
    return nodes;
}