...
Vertex3::Vertex3(int id,double longitude, double latitude): id(id), longitude(longitude), latitude(latitude) {}
...
double Vertex3::getLatitude() const {
    return latitude;
}

double Vertex3::getLongitude() const {
    return longitude;
}
...
double Edge3::getDistancia()const {
